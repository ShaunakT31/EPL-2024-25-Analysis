...
project-root/
│
├── scraper.ipynb # Web scraping notebook to extract Premier League player data from Understat
├── analysis_1_player_value.ipynb # Analysis 1: Player Value based on xG + xA per 90
├── analysis_2_player_efficiency.ipynb # Analysis 2: Player Efficiency and Shot Profiles
├── analysis_3_team_dependency.ipynb # Analysis 3: Team Dependency on Star Players
├── analysis_4_team_buildup.ipynb # Analysis 4: Team Build-Up and Progression Profiles
